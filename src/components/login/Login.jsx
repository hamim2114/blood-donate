				...
				<div className="mt-3 w-full px-6 py-2">
					<div className="w-full">
						<div className="flex items-center mt-5">
							<div className="flex w-full border border-gray-300 rounded-md">
								<button className="flex items-center justify-center required px-5 py-1 border-r">
									<div className="font-semibold text-center text-gray-400"><i className="fas fa-phone-alt pt-3 text-xl"></i></div>
								</button>
								<input type="text" className="w-full px-4 py-3 rounded-md text-gray-700 focus:outline-blue-400 text-lg focus:rounded-none placeholder:text-gray-500"
						...
						<div className="flex items-center mt-5">
							<div className="flex w-full border border-gray-300 rounded-md">
								<button className="flex items-center justify-center required px-5 py-1 border-r">
									<div className="font-semibold text-center text-gray-400"><i className="fas fa-key pt-3 text-xl"></i></div>
								</button>
