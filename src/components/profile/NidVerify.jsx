				...
				<section className="col-span-12 lg:col-span-9">
					...
					<section className="bg-white rounded">
						<div className="p-2 mt-4">
							<h3 className="text-2xl font-semibold">NID Information</h3>
							<div className="rounded border mt-2">
								{/* <!-- Tabs --> */}
								<ul id="tabs" className="inline-flex pt-2 px-1 w-full border-b">
								  <li className="bg-gray-100 px-4 text-gray-800 font-semibold py-2 rounded-t border-t border-r border-l -mb-px"><a id="default-tab" href="#first">Fill Up</a></li>
								  <li className="px-4 text-gray-800 font-semibold py-2 rounded-t"><a href="#second">Upload</a></li>
								</ul>
								...
								<div id="tab-contents">
									<div id="first" className="p-4">
										<div className="w-full flex flex-col sm:flex-row gap-2">
											<div className="w-full mt-2">
												<label className="inline-block p-2 text-base" for="Birth Date">Birth Date</label>
												<input className="w-full bg-[#FBFBFB] px-4 cursor-pointer border border-[#E3E3E3] py-3 text-base font-normal text-gray-800 placeholder-[#AFAFAF] rounded-md bg-gray-light focus:outline-none"
												type="date" placeholder="Birth Date"/>
											</div>
											<div className="w-full mt-2">
												<label className="inline-block p-2 text-base" for="NID Number">NID Number</label>
												<input className="w-full bg-[#FBFBFB] px-4 border border-[#E3E3E3] py-3 text-base font-normal text-gray-800 placeholder-[#AFAFAF] rounded-md bg-gray-light focus:outline-none"
													type="number" placeholder="NID Number"/>
											</div>
										</div>
									</div>
									<div id="second" className="hidden p-4">
										<div className="w-full flex flex-col sm:flex-row gap-2">
											<div className="w-full mt-2">
												<label className="inline-block p-2 text-base" for="Upload File">Upload File</label>
												<input className="w-full bg-[#FBFBFB] px-4 border border-[#E3E3E3] py-3 text-base font-normal text-gray-800 placeholder-[#AFAFAF] rounded-md bg-gray-light focus:outline-none"
