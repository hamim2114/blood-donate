				...
				<div className="w-full divide-y divide-y-gray-100 lg:divide-y-0 flex lg:items-center flex-col
					...
					<div>
						...
						<ul className="peer-hover:flex absolute hover:flex flex-col bg-white drop-shadow-lg hidden pt-0 shadow text-gray">
							<li className="text-left menu"><Link className="block py-2 pl-2 whitespace-no-wrap rounded-t px-2 hover:bg-green-700 hover:text-white" to="/speece">Organization's speece</Link></li>
					...
					<div>
						<div className="relative text-gray-600">
							<input name="serch" placeholder="Search" className="md:w-[80px] lg:w-[90px] xl:w-32 placeholder:text-center bg-white h-9 px-4 pr-7 border border-gray-300 rounded-full text-sm focus:outline-none"/>
